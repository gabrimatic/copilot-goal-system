...
- Drift warnings are recoverable. Stale tool use escalates from warning to critical reminder, but default installs do not deny every tool call when the update tool is missing or ignored.
